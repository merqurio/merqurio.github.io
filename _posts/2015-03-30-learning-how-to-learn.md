...
While studying my career I had a really hard time in the 4th year when all my habits and study methods became useless. Here is a little collection of things that helped me to create new methods.
...
- *"Focused mode"* is perfect to resolve repetitive tasks and it helps you creating new pieces of memories (a.k.a [chunks](#chunks)).
...
- Needs a different state of mind. A more abstract thinking. It can be achieved in  different ways. A great example is while doing any kind of physical activity like running. An [example](http://www.newscientist.com/article/mg21729023.100-how-should-we-use-the-keys-to-sleep.html#.VS0qsiOqqko).
...
![A representation of memories working together]({{ site.url }}/assets/img/posts/memory.png)
...
Creating knowledge is an **active task** and by making an active effort learning is easier than just doing a passive effort like listening. Using the knowledge you are acquiring makes it easier to learn.
...
<a id="chunks"></a>
**Chunks**, are unique pieces of information throw a meaning.
...
2. Try to understand the **main basic idea**. Trying to understand **why** something is that way can ease the work and make it easier to remember.
...
## 4. Keeping knowledge
To keep a chunk fresh, you must maintain that pattern. That needs an extra effort.
...
4. **Do it.** You will amplify the pattern you created. Try to do an activity that uses that chunk as part of the process.
...
#### Library of chunks
Having different and bigger libraries will help you to solve problems more easily in new and different ways. When you have a big chunk library, previously studied concepts can help you to learn new ones, even if they are not related at all. Having a big library, diffused mode can create new a creative things.

#### Mastering something
To master something means to use those chunks you already know as a base to create more and deeper knowledge. If you have expertise in only one area, you will be able to have more robust knowledge on that specific area, but mastering more than one area will help you to find new
and creative solutions more easily.

### Tips &amp; tricks

#### Association with mental images
A nice and easy way to remember thing is to enhance your chunks with images that represent the data in an image. Example a patients look when has X disease.
...
## 7. Workflow
The firsts steps must be a **first approach** the subject you are just about to learn. Understanding the subject itself and its importance in a global context. Next step is to understand the parts that make the subject.

![Learning process]({{ site.url }}/assets/img/posts/process.svg)
...
#### 1. Pomodoro technique [(link)](http://en.wikipedia.org/wiki/Pomodoro_Technique) → Work in highly focused time intervals and then take a break.
...
## 11. Overlearning
Once you understand a concept, repeating the concept in the same session doesn't help to memorise it better. It's important to try to focus on those things that are harder to you. Keep on studying until you find something harder and focus on it → Deliberate practice.
